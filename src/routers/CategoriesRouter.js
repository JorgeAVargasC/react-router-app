    ...
    return (
        <div>
            ...
            <Switch>
                ...
                <PrivateRoute exact path="/categories/anime" component={() => <h1>Category Anime</h1>} />
                <Route path="*">
                    <Redirect to="/404" />
                </Route>
            </Switch>
...
function TerrorRouter() {
    ...
    return (
        <div>
            ...
            <Switch>
                <Route exact path={`${url}`}> <h3>Category Terror</h3></Route>
                <Route exact path={`${url}/gore`}> <h3>Gore</h3></Route>
                <Route exact path={`${url}/suspense`}> <h3>Suspense</h3></Route>
                <Route path="*">
                    <Redirect to="/404" />
                </Route>
            </Switch>
